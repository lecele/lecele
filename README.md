...
## 🌐 Portal Principal: Agentes na Saúde
O **[Agentes na Saúde](https://agentesnasaude.com.br)** é a nossa plataforma central de soluções clínicas de elite. Um ecossistema de agentes inteligentes operando em produção para hospitais, clínicas e profissionais de saúde, focado em segurança de dados (LGPD) e interoperabilidade nativa sob o padrão global **HL7® FHIR®**.
*   **🔗 Link da Plataforma Principal:** [agentesnasaude.com.br](https://agentesnasaude.com.br)
...
### 💊 **MedCron** — Gestão Inteligente de Receituários & Medicações
...
### 🩹 **SANA** — Monitoramento Pós-Operatório & Assistência Remota
...
### 🧠 **InterAtiva** — Paciente Virtual Inteligente para Simulação
...
### 🎨 **_brida** — Assistente de UX & Design de Produtos
...
## 📂 Projetos Públicos Open-Source

### 📞 **[Acolhe-Regis](https://github.com/lecele/Acolhe-Regis)** — Ouvidoria Hospitalar Virtual 24h
...
*   **Arquiteturas Clínicas:** Interoperabilidade HL7® / FHIR®, segurança de dados em conformidade com a LGPD, telemetria de sinais e ondas multiparamétricas de alta frequência.
*   **Frontend:** Next.js (15+), React 19, Tailwind CSS v4, Framer Motion, Vanilla CSS.
*   **Backend:** Python (FastAPI), Node.js, RESTful APIs de microsserviços.
*   **Banco de Dados:** Supabase, PostgreSQL, SQLite on-device, RAG/Bancos Vetoriais.
